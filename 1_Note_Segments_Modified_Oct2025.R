...
rm(list = ls())
setwd("C:/Users/suyas/OneDrive/Desktop/WBS_songs/Sholicola songs selection tables/UU__-2021") 
...
Note_segment(File="Combine-notes-UU__-2021.txt",#name of the file to be segmented
             Input.Path="C:/Users/suyas/OneDrive/Desktop/WBS_songs/Sholicola songs selection tables/UU__-2021",#path to the file to be segmented
             Output.Path="C:/Users/suyas/OneDrive/Desktop/WBS_songs/Sholicola songs segments/UU__-2021", #save to wd, this is not incorporated in the script yet
